            ...
            <div class="collapse navbar-collapse flex-grow items-center" id="navbarSupportedContent1">
                ...
                <ul class="navbar-nav flex flex-col pl-0 list-style-none mr-auto">
                    <li class="nav-item p-2">
                        <a class="nav-link text-gray-500 {{ ($title === "Home")? 'text-white' : '' }}" href="/">Home</a>
                    </li>
                    <li class="nav-item p-2">
                        <a class="nav-link text-gray-500 opacity-60 hover:opacity-80 focus:opacity-80 p-0 {{ ($title === "Shop")? 'text-white opacity-100' : '' }}"
                            href="/shop">Shop</a>
                    </li>
                    <li class="nav-item p-2">
                        <a class="nav-link text-gray-500 opacity-60 hover:opacity-80 focus:opacity-80 p-0 {{ ($title === "About")? 'text-white opacity-100' : '' }}"
                            href="/about">About</a>
                    </li>
                </ul>
                <!-- Left links -->
